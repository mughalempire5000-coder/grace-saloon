    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Create a new salon partner</p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="shadow-soft">
              <CardHeader>
                ...
                <CardDescription>Add services offered by this vendor</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card className="shadow-soft">
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="p-3 rounded-lg bg-primary/10">
                  <p className="font-medium text-primary mb-1">Complete Profile</p>
                  <p className="text-muted-foreground">Fill all details for better visibility</p>
                </div>
                <div className="p-3 rounded-lg bg-blue-50">
                  <p className="font-medium text-blue-700 mb-1">Add Services</p>
                  <p className="text-muted-foreground">Include all services with accurate pricing</p>
                </div>
                <div className="p-3 rounded-lg bg-green-50">
                  <p className="font-medium text-green-700 mb-1">Contact Info</p>
                  <p className="text-muted-foreground">Ensure contact details are correct</p>
                </div>
              </CardContent>
            </Card>
          </div>
